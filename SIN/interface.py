...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly", # tu dodać 
                                    values=('BFS', 'DFS (Graph Search)', 'DFS (Backtracking)', 'Voraz (Manhattan)', 'ID', 'A* Manhattan', 'A* Euclidean', 'IDA* Manhattan', 'Mispl', 'seq', 'h4'))
    ...
    def solveState():
        ...
        elif str(algorithm) == 'Mispl':
            main.graphSearch(initialState,main.function_0, main.getMispl)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter

        elif str(algorithm) == 'seq':
            main.graphSearch(initialState,main.function_0, main.seq)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter

        elif str(algorithm) == 'h4':
            main.graphSearch(initialState,main.function_0, main.h4)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
