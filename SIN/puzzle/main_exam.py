...
def misplaced(state: str):
    total = 0
    for i in range(len(state)):
        if int(state[i]) != 0 and state[i] != end_state[i]:
            total += 1
    return total
...
def manhattan_misplaced(state):
    # return max(getManhattanDistance(state), misplaced(state))
    # return (getManhattanDistance(state) + misplaced(state))/2
    # return getManhattanDistance(state) * misplaced(state)
    return getManhattanDistance(state) + misplaced(state)
...
if __name__ == "__main__":
    ...
    print("manhattan", getManhattanDistance("123784065"))
    print("misplaced", misplaced("123784065"))